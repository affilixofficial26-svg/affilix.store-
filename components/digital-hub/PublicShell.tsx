...
const navigation = [
  ...
  ["Comparador", "/comparador"], ["Recursos", "/recursos"], ["Planes", "/planes"], ["Afiliados", "/afiliados"],
];
...
export function PublicFooter() {
  return <footer className="hub-footer"><div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-6">
    <div><div className="flex items-center gap-3"><Image src="/brand/logo/affilix-logo-approved.png" alt="AFFILIX" width={220} height={55} className="h-12 w-auto object-contain"/></div><p className="mt-4 text-lg font-black text-white">Crea. Vende. Automatiza.</p><p className="mt-3 max-w-xs text-sm leading-6 text-slate-500">Productos digitales, servicios IA, kits y herramientas para impulsar tu negocio.</p></div>
