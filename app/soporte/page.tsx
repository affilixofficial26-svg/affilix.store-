...
const faqs = [
  ...
  ["Servicios IA", "Cada servicio indica formulario, precio, tiempo y revisiones incluidas."],
  ["Programa de afiliados", "Los afiliados aprobados reciben enlaces, materiales y comisiones."],
  ["Cuenta y datos", "Puedes solicitar revisión o eliminación de datos desde soporte."],
  ["Legal", "Las políticas vigentes están publicadas en la sección legal."],
];
  ...
  return (
    <PublicShell>
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-6">
        ...
        <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">Respuesta en 24h laborables en horario España. Si una entrega falla, abrimos incidencia y reintentamos.</p>
