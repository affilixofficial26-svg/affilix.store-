...
const panelPages: Result[] = [
  ...
  { label: "Integraciones", description: "Conecta cuentas, servicios y plataformas operativas.", href: "/dashboard/integrations", type: "pagina" },
  { label: "Fabrica de Nichos", description: "Busca nichos, oportunidades y productos digitales rentables.", href: "/dashboard/niche-factory", type: "pagina" },
  ...
  { label: "Cuentas conectadas", description: "Credenciales internas y cuentas operativas.", href: "/dashboard/accounts", type: "pagina" },
