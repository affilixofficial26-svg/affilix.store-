    ...
    <PublicShell>
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-16 lg:grid-cols-[1fr_.8fr] lg:px-6">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">Cuéntanos qué necesitas: soporte, colaboración, producto digital, servicio IA o programa de afiliados.</p>
