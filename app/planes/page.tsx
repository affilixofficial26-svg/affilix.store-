...
const plans = [
  ...
  ["Creditos IA", "Desde 15 EUR", "100, 500 o 2.000 creditos para servicios IA. Validez 12 meses."],
  ["Plan Pro", "19 EUR/mes", "10 servicios IA/mes, 500 creditos, prioridad en cola."],
  ["Plan Business", "79 EUR/mes", "50 servicios IA/mes, 3.000 creditos, revision humana en 24h."],
  ...
  return (
    <PublicShell>
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-6">
        ...
        <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">Compra una vez, usa creditos IA, entra como afiliado o activa un plan mensual.</p>
